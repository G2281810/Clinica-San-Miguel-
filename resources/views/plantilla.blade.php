    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="{{ route ('consulta_pacientes')}}">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="{{ route ('reportecupon')}}">
              <i class="material-icons">library_books</i>
              <p>Cupones</p>
            </a>
          </li>
          <li class="nav-item active">
            <a class="nav-link" href="{{ route ('reporte_recetas')}}">
              <i class="material-icons">library_books</i>
              <p>Recetas</p>
            </a>
          </li>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Clínica San Miguel</a>
          </div>
