  ...
  <div class="row">
    <div class="col-md-11 ml-auto mr-auto">
      <div class="card">
        ...
        <div class="card-body">
          <form action="{{ route ('guardarpaciente')}}" method="POST" enctype = 'multipart/form-data'>
            {{csrf_field()}}
            <div class="row">
              <div class="col-md-2">
                <div class="form-group">
                  <label class="bmd-label-floating">Clave paciente</label>
                  <input type="text" class="form-control" value="{{$idsigue}}"   name="idpaciente" disabled>
                </div>
              </div>
